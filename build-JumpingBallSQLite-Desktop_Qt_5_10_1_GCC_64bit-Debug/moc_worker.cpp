...
QT_MOC_LITERAL(3, 19, 9), // "BallState"
QT_MOC_LITERAL(4, 29, 5), // "state"
QT_MOC_LITERAL(5, 35, 8), // "finished"
QT_MOC_LITERAL(6, 44, 17), // "calculateNewState"
QT_MOC_LITERAL(7, 62, 4) // "stop"

    },
    "Worker\0stateReady\0\0BallState\0state\0"
    "finished\0calculateNewState\0stop"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stateReady((*reinterpret_cast< BallState(*)>(_a[1]))); break;
        case 1: _t->finished(); break;
        case 2: _t->calculateNewState((*reinterpret_cast< BallState(*)>(_a[1]))); break;
        ...
        {
            typedef void (Worker::*_t)(BallState );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::stateReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Worker::stateReady(BallState _t1)
{
